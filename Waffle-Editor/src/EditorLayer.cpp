...
namespace Waffle {
	...
	void EditorLayer::OnUpdate(Waffle::Timestep ts)
	{
		WF_PROFILE_FUNCTION();

		if (Waffle::FramebufferSpecification spec = m_Framebuffer->GetSpecification();
...

		{
			...
			Renderer2D::DrawQuad({ -1.0f, 0.0f }, { 0.8f, 0.8f }, m_Color);
			Renderer2D::DrawQuad({ 0.0f, 0.0f, -0.1f }, { 20.0f, 20.0f }, m_CheckerboardTexture, 10.0f);
			Renderer2D::DrawRotatedQuad({ -2.0f, 0.0f, 0.0f }, { 1.0f, 1.0f }, glm::radians(rotation), m_CheckerboardTexture, 5.0f);
