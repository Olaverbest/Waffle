...
#define WF_PROFILE 0
    ...
    #define WF_PROFILE_END_SESSION() ::Waffle::Instrumentor::Get().EndSession()
    #define WF_PROFILE_SCOPE(name) ::Waffle::InstrumentationTimer timer##__Line__(name);
    #define WF_PROFILE_FUNCTION() WF_PROFILE_SCOPE(__FUNCSIG__)
#else
